<template>
  <div class="container-edit">
    <el-dialog :title="title" :visible.sync="isVisible" custom-class="dialog-container">
      <el-form :model="articleInfo" label-position="left" size="small">
        <el-form-item label="标题：" :label-width="formLabelWidth">
          <el-input :value="articleInfo.title" autocomplete="off" disabled>
          </el-input>
        </el-form-item>

        <el-form-item label="标签：" :label-width="formLabelWidth">
          <el-select v-model="articleInfo.labelIds" multiple disabled
            style="display: block;">
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="是否公开：" :label-width="formLabelWidth">
          <!-- 0: 不公开 1：公开 -->
          <el-switch :value="articleInfo.isPublic === 1" disabled></el-switch>
        </el-form-item>

        <el-form-item label="简介：" :label-width="formLabelWidth">
          <el-input type="textarea" :value="articleInfo.summary" disabled>
          </el-input>
        </el-form-item>
      ...
      <div class="dialog-footer" slot="footer">
        ...
        <template v-else>
          ...
          <el-button type="primary" @click="submitForm('success')">审核通过
          </el-button>
        </template>
      </div>
    </el-dialog>
